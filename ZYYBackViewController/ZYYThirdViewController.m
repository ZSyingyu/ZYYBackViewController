...
@interface ZYYThirdViewController ()

@end

@implementation ZYYThirdViewController
...
- (void)btnAction {
    ZYYFourthViewController *fourthVc = [[ZYYFourthViewController alloc] init];
